  ...
  <div class="app-container">
    ...
    <div class="head-container">
      <div class="crud-opts">
        <span class="crud-opts-left">
          ...
          <el-button v-permission="['menu:update']" class="filter-item" size="mini" type="success" icon="el-icon-edit" :disabled="menuSelections.length !== 1" @click="handleUpdate(menuSelections[0])"> 修改 </el-button>
    ...
    >
      ...
      <el-table-column label="操作" align="center" width="230">
        <template slot-scope="{ row }">
          <el-button v-permission="['menu:update']" size="mini" type="primary" icon="el-icon-edit" @click="handleUpdate(row)" />
