    ...
    <div class="head-container">
      <div class="crud-opts">
        <span class="crud-opts-left">
          ...
          <el-button class="filter-item" size="mini" type="success" icon="el-icon-edit" :disabled="deptSelections.length !== 1" @click="handleUpdate(deptSelections[0])"> 修改 </el-button>
          <el-button class="filter-item" type="danger" icon="el-icon-delete" size="mini" :disabled="deptSelections.length !== 1" @click="handleDelete(deptSelections[0])"> 删除 </el-button>
        </span>
      </div>
    </div>
    <!-- 表格渲染 -->
