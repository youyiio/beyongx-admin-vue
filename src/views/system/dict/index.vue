      ...
      <el-col :xs="24" :sm="24" :md="19" :lg="19" :xl="19">
        <el-card class="box-card">
          <div slot="header" class="clearfix">
            <span>字典详情</span>
            <el-button v-permission="['config:create']" class="filter-item" size="mini" type="primary" icon="el-icon-plus" style="float: right;padding: 4px 10px" @click="handleCreate()"> 新增 </el-button>
          </div>
