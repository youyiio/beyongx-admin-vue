          ...
          <div>
            <el-form ref="dataForm" :model="formData" :rules="rules" label-width="80px" size="mini" style="margin-left:50px;">
              ...
              <el-form-item label="文章分类" prop="categoryIds">
                <treeselect v-model="formData.categoryIds" :multiple="true" :flat="true" :searchable="false" :options="categoryOptions" :normalizer="normalizer" style="width: 600px;" placeholder="选择所属分类" size="mini" @change="test()" />
              </el-form-item>
