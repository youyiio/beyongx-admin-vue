    ...
    <div class="head-container">
      <div class="crud-opts">
        <span class="crud-opts-left">
          ...
          <el-button v-permission="['category:update']" class="filter-item" size="mini" type="success" icon="el-icon-edit" :disabled="categorySelections.length !== 1" @click="handleUpdate(categorySelections[0])"> 修改 </el-button>
    ...
    <el-table ref="categoryTable" :key="tableKey" v-loading="listLoading" :data="list" :tree-props="{children: 'children', hasChildren: 'hasChildren'}" row-key="id" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" width="230">
        <template slot-scope="{ row }">
          <el-button v-permission="['category:update']" size="mini" type="primary" icon="el-icon-edit" @click="handleUpdate(row)" />
          <el-popconfirm v-permission="['category:delete']" title="确认删除本条数据吗？" @onConfirm="handleDelete(row)">
